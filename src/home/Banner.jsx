...
const desc = "We Have the larget collection of Products";
...
const Banner = () => {
    ...
    const handleSearch = e =>{
        ...
        const filterd = productData.filter((product) => product.name.toLocaleLowerCase().includes(searchTerm.toLocaleLowerCase()));
